export const portfolioDetails = [
	...
	},
	{
		...
		'Lesson Learned':
			'I learned a lot working with C#, Windows Forms in Visual Studio, Azure, and SQL Server. I gained experience in creating multiple screens, navigating, OOP principles, database management, and handling user inputs securely.',
		'Tech Stack': 'C#, Windows Forms, Azure, SQL Server, Visual Studio',
		'How to Run': 'Visit the GitHub link for the guide on installation and importation',
		'Sample Login Details': {
			Admin: {
				username: 'admin',
				password: 'admin',
		...
		'Project Purpose and Goal':
			'The goal of this project was to create a comprehensive Employee Management System that is easy to use, secure, and efficient. It aimed to streamline employee and department management processes and ensure secure access control.',
		'Web Stack and Explanation':
			'I used C# for the frontend and backend, Windows Forms for the UI, Azure for cloud services, and SQL Server for the database. C# was chosen for its robustness and ease of use, while Azure and SQL Server were chosen for their scalability and reliability.',
		'Problems and Thought Process':
			'The most challenging part of the project was ensuring secure authentication and authorization. I had to make sure that user inputs were properly validated and that the system handled multiple access levels correctly. I also focused on efficient database management and seamless navigation between screens. In the future, I plan to add more features such as detailed reporting and analytics, and integration with other systems.',
		'Project Link': 'https://github.com/udabasili/Employee-Management-System',
		'GitHub Link': 'https://github.com/udabasili/Employee-Management-System',
		Video: 'https://github.com/udabasili/Employee-Management-System/assets/33573587/34da1598-6a57-476e-8acf-45639c736706',
		color: '#F1CC59',
		'Screenshots or animated GIFs': '',
	},
	{
